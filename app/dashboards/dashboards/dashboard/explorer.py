...
layout = html.Div([
    ...
    dbc.Row([
        dbc.Col([
            html.Div([
                dcc.Dropdown(id='explorer-x', multi=False, options=list_to_dropdown_options(all_columns), placeholder='X-axis', value=all_columns[0]),
                dcc.Dropdown(id='explorer-y', multi=False, options=list_to_dropdown_options(all_columns), placeholder='Y-axis', value=all_columns[1]),
                dcc.Dropdown(id='explorer-color', multi=False, options=list_to_dropdown_options(all_columns), placeholder='Color', value=all_columns[2]),
                dcc.Dropdown(id='explorer-size', multi=False, options=list_to_dropdown_options(all_columns), placeholder='Marker size', value=all_columns[3]),
