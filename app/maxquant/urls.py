...
urlpatterns = [
    path('detail/<slug:project>/<slug:pipeline>', views.maxquant_pipeline_view, name='detail'),
    ## download concatenated MaxQuant files in csv format
    path('download/pipeline/<pk>', views.pipeline_download_file, name='pipeline-download-file'),
